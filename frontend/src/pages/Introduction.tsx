  ...
  return (
    <section className="page-body prose">
      ...
      <p className="tz-lead">{es
        ? 'ChancaDEM es un estudio de física de chancado en el navegador. Los controles fijan la máquina (giratoria primaria, mandíbula, cono secundario/terciario o short-head), el setting de lado cerrado (CSS), la carrera y la velocidad excéntrica, y la granulometría de alimentación; el estudio calcula la gradación del producto, la capacidad y la potencia, y muestra por qué.'
        : 'ChancaDEM is an in-browser crusher-physics studio. The controls set the machine (primary gyratory, jaw, secondary/tertiary cone or short-head), the closed-side setting (CSS), the eccentric throw and speed, and the feed size distribution; it computes the product gradation, throughput and power, and shows why.'}</p>
      ...
      <h3>{es ? 'La operación de chancado' : 'The crushing operation'}</h3>
      <p>{es
